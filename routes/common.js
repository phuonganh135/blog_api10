...
router.route('/api/thoigian_all')
    .get(thoigianController.getThoiGianListAll)
...
router.route('/api/detai_sinhvien_chapnhan_check_isregister')
    .get(detaiController.getDeTaiListChapNhanCheckIsRegister)
